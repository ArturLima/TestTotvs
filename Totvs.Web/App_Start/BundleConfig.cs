    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include(
                      ...
                      "~/Scripts/respond.js",
                      "~/Scripts/Service/ProductOrderService.js",
                      "~/Scripts/Controller/ProductOrderController.js",
                      "~/Scripts/Service/OrdersService.js",
                      "~/Scripts/Controller/OrdersController.js"
                      ));
